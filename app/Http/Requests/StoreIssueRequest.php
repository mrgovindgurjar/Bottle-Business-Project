...
{
    public function authorize(): bool { return auth()->check() && auth()->user()->hasPermission('issues.create'); }
    public function rules(): array { return [
        ...
        'priority'=>['required',Rule::in(['low','normal','high','urgent'])],'status'=>['nullable',Rule::in(['open','in_progress','pending_customer','resolved','closed','cancelled'])],
